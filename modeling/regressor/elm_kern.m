function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,Y,TY,OutputWeight,Omega_train,Omega_test] = elm_kern(Omega_train, train_labels, Omega_test, test_labels, Elm_Type, Regularization_coefficient)
